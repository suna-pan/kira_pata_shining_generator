...
(function() {
  $(function() {
    var draw_res, f_delta_h, f_delta_x, f_delta_y, f_rep_cnt, f_right, file, hsv_to_rgb, proc_image, res_canvas, res_ctx, result, rgb_to_hsv, tmp_canvas, tmp_ctx;
    file = null;
    result = $('#result_image');
    f_rep_cnt = $('#rep_count');
    f_delta_x = $('#delta_x');
    ...
    tmp_canvas.hide();
    res_canvas.hide();
    draw_res = function(x, y, w, h, image_data) {
      var idx, j, k, ref, ref1, res_image, xx, yy;
    ...
    return $('#process').click(function() {
      var delta_h, delta_x, delta_y, draw_y, image, reader, rep_cnt, right;
      if (file === null) {
        return;
      }
      ...
      reader.onload = function(evt) {
        image.onload = function() {
          var dh, h, i, image_data, img, j, png, ref, rh, rw, w;
          res_canvas.hide();
          w = this.width;
          h = this.height;
          ...
          image_data = tmp_ctx.getImageData(0, 0, w, h);
          if (!right) {
            draw_res((rep_cnt - 1) * delta_x, draw_y, w, h, image_data);
          }
          if (right) {
            draw_res(0, draw_y, w, h, image_data);
          }
